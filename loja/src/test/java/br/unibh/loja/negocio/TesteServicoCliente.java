...
public class TesteServicoCliente {
	...
	public void teste01_inserirSemErro() throws Exception {
		...
		Cliente o = new Cliente(1L, "Vinicius", "vinicim1997", "senha", "vinic", "12876581647", "(11)9811-1111",
				"vinicim1997@gmail.com", new Date(), new Date());

		ss.insert(o);

		Cliente aux = (Cliente) ss.findByName("Vinicius").get(0);
	...
	public void teste03_atualizar() throws Exception {
		...
		Cliente o = (Cliente) ss.findByName("Vinicius").get(0);

		o.setNome("Vinicius modificado");

		ss.update(o);

		Cliente aux = (Cliente) ss.findByName("Vinicius modificado").get(0);
	...
	public void teste04_excluir() throws Exception {
		...
		assertEquals(0, ss.findByName("Vinicius modificado").size());
